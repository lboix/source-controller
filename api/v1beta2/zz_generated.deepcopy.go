...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MatchOIDCIdentity) DeepCopyInto(out *MatchOIDCIdentity) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MatchOIDCIdentity.
func (in *MatchOIDCIdentity) DeepCopy() *MatchOIDCIdentity {
	if in == nil {
		return nil
	}
	out := new(MatchOIDCIdentity)
	in.DeepCopyInto(out)
	return out
}
